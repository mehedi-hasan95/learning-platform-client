...
const Login = () => {
    ...
    const { googleSignIn, loginWithEmail, githubLogIn } = useContext(AuthContext);
            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 text-gray-100">
                ...
                <form onSubmit={handleLogin} className="space-y-6 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="email" name="email" id="username" placeholder="Your Email" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 text-black focus:dark:border-violet-400" />
                    </div>
                    <div className="space-y-1 text-sm">
                        <label className="block dark:text-gray-400">Your Password</label>
